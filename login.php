...
if ( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
    ...
    if ( !isset($_POST['username']) || !isset($_POST['password']) ) {
        ...
        $result = $databasePeople->loginUtente($_POST['username'], $_POST['password']);
        ...
        if ( $result['result'] == NULL ) {
            ...
            $_SESSION['user_id']    = intval($result['result']);
...
<head>
    <meta charset="UTF-8">
    <title>PEOPLES Framework - Login</title>
    ...
    <div class="ui two column middle aligned centered grid">
        <div class="column">
            <h2 class="ui header component">
                <div class="content ">
                    <span class="text black">PEOPLES Framework login</span>
                </div>
            </h2>
        </div>
           ...
           <div class="center aligned column">
               <form action="./login.php" method="POST" id="form_login">
                   ...
                   <div class="ui fluid input">
                    ...
                    <button class="ui labeled button green btn_login" type="submit">
                        Login
                    </button>
                </form>
               <hr/>
               <a class="ui labeled button blue btn_register" href="./register.php">
                   Register
               </a>
            </div>
